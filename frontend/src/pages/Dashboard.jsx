            ...
            <main className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <StatCard title="Total Projects" value="1,248" icon={Activity} color="bg-blue-500" />
                        <StatCard title="Active Discrepancies" value="86" icon={AlertTriangle} color="bg-red-500" />
                        <StatCard title="Citizen Reports" value="342" icon={Users} color="bg-purple-500" />
                        <StatCard title="Funds at Risk" value="₹42.5Cr" icon={IndianRupee} color="bg-amber-500" />
                    </div>
