...
import { LayoutDashboard, Map as MapIcon, FileText, Mail, Search, Bell, Plus, Upload, FileSearch, Cpu, CheckCircle, AlertCircle, ArrowRight, Loader2, MapPin } from 'lucide-react';
...
const DocumentAnalysis = () => {
    ...
    const processFile = (uploadedFile) => {
        ...
        setTimeout(() => {
            setIsScanning(false);
            setAnalysisResult({
                projectName: "Metro Line 3 - Phase 2 Expansion",
                budget: "₹45,00,00,000",
                contractor: "Apex Infrastructure Ltd.",
                startDate: "2023-09-15",
                endDate: "2025-03-30",
                location: "MG Road Corridor, Bengaluru",
                confidence: 98.5
            });
        }, 3000);
    };
    ...
    const handleReportInconsistency = () => {
        console.log("Redirecting to report with data:", analysisResult);
        navigate('/submit');
    };
